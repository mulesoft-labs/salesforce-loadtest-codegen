...
-----------------------------------------------------------------
./src/test/java/org/mule/application/salesforcetointacct/SalesForceToIntacctTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/salesforcetointacct-functional-test-config.xml

Defines the Mule configuration for the SalesForceToIntacctTestCase.java.
...
artifactId=salesforcetointacct
description=
muleVersion=3.1.1
packagePath=com/mycompany/mule
forgeProject=n
transports=file,http,jdbc,jms,vm
modules=cxf,scripting,xml,client

version=1.0-SNAPSHOT
groupId=org.mule.application
basedir=/Users/albinkjellin/Documents/mule/workspace
--------------------------------------------------------------------